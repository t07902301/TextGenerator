...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        nargs="?",
        help="Define what kind of background to use. 0:Plain white, 1: Quasicrystal, 2：Image, 3: random",
        default=0,
    )
    parser.add_argument(
        "-hw",
    ...
    parser.add_argument(
        ...
        default=os.path.join(os.path.split(os.path.realpath(__file__))[0], "images/yyzz"),
    )
    parser.add_argument(
        "-ca",
        "--case",
    ...
    parser.add_argument(
        ...
        default=0,
        nargs="?",
        help=" Define degree of light. Generate random degree between the positive and negative value of the input",
    )
    parser.add_argument(
        "-ns",
        "--noise",
...
def main():
    ...
    #             [args.name_pre] * string_count,
    #             [font_dict] * string_count,
    #         ),
    #     ),
    #     total=args.count,
    # ):
    ...
    if args.name_format == 2:
        ...
        with open(
            ...
            for i in range(string_count):
                file_name = args.name_pre + '_' + str(i) + "." + args.extension
...
if __name__ == "__main__":
    main()
    # with open('texts/result.txt', "r", encodintf8") as f:
