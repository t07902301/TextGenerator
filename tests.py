...
if __name__ == "__main__":
    unittest.main()
    # -l cn -c 100000 -w 20 -na 2 -npre char_syn1 -k 1 -rk -b 3 -i C:/DM_hcn/project/data_generator/TextRecognitionDataGenerator/trdg/dicts/char_chinese_8637.txt --output_dir C:/DM_hcn/data/ocr/char_syn/char_syn1
    # -l en -c 20000 -w 3 -na 2 -npre num_syn1 -rs -k 1 -rk -b 3 -num --output_dir C:/DM_hcn/data/ocr/math_ch_print/img/num_syn/num_syn1
    # -l en -c 20000 -w 3 -na 2 -npre num_letter_syn1 -rs -k 1 -rk -b 3 -num -let --output_dir C:/DM_hcn/data/ocr/math_ch_print/img/num_letter_syn/num_letter_syn1
